...
" Suppress default Vim mode display (-- INSERT -- etc.) to avoid overlap with lightline
set noshowmode

" Statusline is now managed by lightline; legacy manual statusline is disabled below:
